...
public extension Groupable {
  ...
  ///
  func groupInCenter(group: Group, views: [any Frameable], padding: CGFloat, width: CGFloat, height: CGFloat) {
    if views.count == 0 {
  ...
  ///   - height: The height of each subview.
  ///
  func groupInCorner(group: Group, views: [any Frameable], inCorner corner: Corner, padding: CGFloat, width: CGFloat, height: CGFloat) {
    switch group {
    case .horizontal:
  ...
  ///   - height: The height of each subview.
  ///
  func groupAgainstEdge(group: Group, views: [any Frameable], againstEdge edge: Edge, padding: CGFloat, width: CGFloat, height: CGFloat) {
    if views.count == 0 {
  ...
  ///   - height: The height of each subview.
  ///
  func groupAndAlign(group: Group, andAlign align: Align, views: [any Frameable], relativeTo sibling: any Frameable, padding: CGFloat, width: CGFloat, height: CGFloat) {
    switch group {
    case .horizontal:
  ...
  ///   - padding: The padding to be applied between each of the subviews and the sibling.
  ///
  func groupAndFill(group: Group, views: [any Frameable], padding: CGFloat) {
    if views.count == 0 {
  ...
  //
  private func groupInCornerHorizontal(views: [any Frameable], inCorner corner: Corner, padding: CGFloat, width: CGFloat, height: CGFloat) {
    if views.count == 0 {
  ...
  private func groupInCornerVertical(views: [any Frameable], inCorner corner: Corner, padding: CGFloat, width: CGFloat, height: CGFloat) {
    if views.count == 0 {
      print("[NEON] Warning: No subviews provided to groupInCorner().")
      return
    }
  ...
  private func groupAndAlignHorizontal(align: Align, views: [any Frameable], relativeTo sibling: any Frameable, padding: CGFloat, width: CGFloat, height: CGFloat) {
    if views.count == 0 {
  ...
  private func groupAndAlignVertical(align: Align, views: [any Frameable], relativeTo sibling: any Frameable, padding: CGFloat, width: CGFloat, height: CGFloat) {
    if views.count == 0 {
      print("[NEON] Warning: No subviews provided to groupAndAlign().")
      return
    }
