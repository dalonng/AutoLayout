...
public extension Alignable {
  ...
  ///
  func align(_ align: Align, relativeTo sibling: any Frameable, padding: CGFloat, width: CGFloat, height: CGFloat, offset: CGFloat = 0) {
  ...
  /// view's y origin will be lower than the sibling view's y origin by 5 points.
  ///
  func alignAndFillWidth(align: Align, relativeTo sibling: any Frameable, padding: CGFloat, height: CGFloat, offset: CGFloat = 0) {
  ...
  /// view's y origin will be lower than the sibling view's y origin by 5 points.
  ///
  func alignAndFillHeight(align: Align, relativeTo sibling: any Frameable, padding: CGFloat, width: CGFloat, offset: CGFloat = 0) {
  ...
  /// view's y origin will be lower than the sibling view's y origin by 5 points.
  ///
  func alignAndFill(align: Align, relativeTo sibling: any Frameable, padding: CGFloat, offset: CGFloat = 0) {
  ...
  /// view's y origin will be lower than the sibling view's y origin by 5 points.
  ///
  func alignBetweenHorizontal(align: Align, primaryView: any Frameable,
                              secondaryView: any Frameable, padding: CGFloat, height: CGFloat, offset: CGFloat = 0)
  {
    let superviewWidth: CGFloat = superFrame.width
    var xOrigin: CGFloat = 0.0
    var yOrigin: CGFloat = 0.0
    ...
    case .aboveCentered, .aboveMatchingLeft, .aboveMatchingRight, .underCentered, .underMatchingLeft, .underMatchingRight:
  ...
  /// view's y origin will be lower than the sibling view's y origin by 5 points.
  ///
  func alignBetweenVertical(align: Align, primaryView: any Frameable,
                            secondaryView: any Frameable,
                            padding: CGFloat,
                            width: CGFloat,
                            offset: CGFloat = 0)
  {
    ...
    case .toTheLeftCentered, .toTheLeftMatchingBottom, .toTheLeftMatchingTop, .toTheRightCentered, .toTheRightMatchingBottom, .toTheRightMatchingTop:
